...
public class EveryEvent extends javax.swing.JDialog {
    ...
    public EveryEvent(java.awt.Frame parent, boolean modal, String s) {
        ...
        GEventTodayModel getoday = new GEventTodayModel(RetrieveData.getGEventEveryday(s));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EveryEvent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
